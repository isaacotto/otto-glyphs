...
{
    name=arrow,
    description={Indicates the continuation of a gesture as laid out in the previously enclosed territory. Large, elaborate arrows indicate transition between one ``sound world'' and another}
}
...
{
    name=dynamics,
    description={Indicated using traditional figures (pp, mf, etc.) or by varying the thickness of the ``stroke'' of the dot, line, or curve. Attack envelopes are demonstrable using changing stroke thickness}
}
...
\newpage
    ...
    \begin{center}
    \includegraphics[width=.25\textwidth]{images/01-blankbracket.png}\footnote{\textit{open improvisation}} \includegraphics[width=.3\textwidth]{images/01-demobracket.png}\footnote{\textit{play something like this combination of attacks}} \includegraphics[width=.4\textwidth]{images/01-demobracket2.png}\footnote{\textit{play something like this combination of attacks}}
    \end{center}

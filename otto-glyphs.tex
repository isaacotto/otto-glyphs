...
% Custom command to place an image in an fbox with a gray border of 4pt
\newcommand{\glyphborder}[2][]{%
    \begingroup
    \vspace{0.5em} % Vertical space before
    \setlength{\fboxsep}{10pt}% Padding between image and frame
    \colorlet{framecolor}{gray!50}%
    % Set pixel width of border
    \setlength{\fboxrule}{4pt}%
    \fcolorbox{framecolor}{white}{\includegraphics[#1]{#2}}%
    \vspace{0.5em}
    \endgroup
}
% To use: \glyphborder[width=3cm]{path/to/image.png}

% Draws the same sort of gray box around a table or other content
\newcommand{\glyphbordercontent}[1]{%
    \begingroup
    \vspace{0.5em} % Vertical space before
    \setlength{\fboxsep}{10pt}% Padding between content and frame
    \colorlet{framecolor}{gray!50}%
    % Set pixel width of border
    \setlength{\fboxrule}{4pt}%
    \fcolorbox{framecolor}{white}{#1}%
    \vspace{0.5em}
    \endgroup
}
...
\newglossarystyle{mystyle}{%
    ...
    \renewcommand*{\glossentry}[2]{%
        ...
        {
        \ifglshasfield{useri}{##1}{\\ \noindent\makebox[\linewidth][c]{\glsentryuseri{##1}}}{}%
...
% The following command provides circled footnote marks. The circles, however, currently vary in size with the size of the number inside. I would like the circles to all be the same size (large enough to accommodate a 2-digit number). Can you help me with this?
...
\newcommand{\circlednum}[1]{%
  \tikz[baseline=(char.base)] \node[draw, circle, minimum size=1.4em, inner sep=0pt, line width=0.4pt, font=\tiny] (char) {#1};%
}
...
\newcommand{\circledfootnote}[2][.3em]{%
  \refstepcounter{footnote}% advance footnote counter (keeps hyperref anchors working)
  \nolinebreak\hspace{#1}\textsuperscript{\circlednum{\thefootnote}}% circled mark in the text with spacing
  \begingroup
    ...
    \noindent\hangindent=1.8em\hangafter=1\circlednum{\thefootnote}\enspace{\color{darkred} ##1}\vspace{0.5em}}%
    \footnotetext{\textit{#2}}% the footnote body (already italicised by the argument)
  \endgroup
}
\makeatother
...
\newglossaryentry{pictograms}
{
    ...
    user1={%
        \glyphborder[width=2.5cm]{images/percussionpictograms01.png}
    },
}
\newglossaryentry{arrow}
{
    ...
    user1={%
        \glyphborder[width=2.5cm]{images/11-arrowplain.png} \hspace*{1cm}
        \glyphborder[width=1.5cm]{images/11-elaboratearrow.png}
    },
}
...
{ 
    ...
    user1={\glyphborder[width=0.5\textwidth]{images/axesexample.png}},
}
...
\newglossaryentry{box}
{
    ...
    user1={
        \glyphborder[width=1cm]{images/01-box.png} \hspace*{0.5cm}
        \glyphborder[width=1cm]{images/01-boxwithair.png} \hspace*{0.5cm}
        \glyphborder[width=1cm]{images/01-boxwithchord.png}
    },
}
...
\newglossaryentry{brackets}
{
    ...
    user1={%
        \glyphborder[width=2cm]{images/01-blankbracket.png} \hspace*{1cm}
        \glyphborder[width=2.5cm]{images/01-3dotscurvebracket.png}
    },
}
...
\newglossaryentry{line}
{
    ...
    user1={\glyphborder[width=4cm]{images/02-varyingstrokeline.png}}
}
...
\newglossaryentry{dynamics}
{
    ...
    user1={\glyphborder[width=.4\textwidth]{images/02-varyingstrokecurve.png}},
}
...
\newglossaryentry{timbre}
{
    ...
    user1={\glyphborder[width=6cm]{images/02-timbre2.png}}
}
...
\newglossaryentry{lollipop}
{
    ...
    user1={\glyphborder[width=3cm]{images/02-lolly1.png}}
}
...
\newglossaryentry{relational signs}
{
    ...
    user1={%
        \glyphborder[width=1cm]{images/03-ignore.png} \hspace*{1cm}
        \glyphborder[width=1cm]{images/03-dominate.png} \hspace*{1cm}
        \glyphborder[width=1cm]{images/03-support.png}
    },
}
...
\newglossaryentry{Pitched material}
{
    ...
    user1={\glyphborder[width=6cm]{images/pitched3.png}}
}
...
\newglossaryentry{interruption}
{
    ...
    user1={\glyphborder[width=1cm]{images/05-interruption3.png} \hspace*{1cm} \glyphborder[width=1cm]{images/05-interruption4.png}}
}
...
\newglossaryentry{multiphonic}
{
    ...
    user1={\glyphborder[width=3cm]{images/04-multiphonics3.png}}
}
...
\newglossaryentry{harmonic}
{
    ...
    user1={\glyphborder[width=4cm]{images/04-harmonics.png}}
}
...
\newglossaryentry{chord}
{
    ...
    user1={%
        \glyphborder[width=1.5cm]{images/04-chords2.png} \hspace*{1cm}
        \glyphborder[width=1.5cm]{images/04-chords3.png}
    },
}
...
\newglossaryentry{duration}
{
    ...
    user1={\glyphborder[width=4cm]{images/08-dur2.png}}
}
...
\newglossaryentry{cue}
{
    ...
    user1={\glyphborder[width=1cm]{images/08-star_alone.png} \hspace*{1cm} \glyphborder[width=3cm]{images/08-star.png}},
}
...
\newglossaryentry{trill}
{
    ...
    user1={\glyphborder[width=4cm]{images/08-trill2.png}}
}
...
\newglossaryentry{dot}
{
    ...
    user1={\glyphborder[width=4cm]{images/02-varyingstrokedot.png}}
}
...
\newglossaryentry{curve}
{
    ...
    user1={\glyphborder[width=2cm]{images/01-curve2.png}}
}
...
\title{On the Use and Interpretation of Otto-Glyphs: A Brief Primer on a Novel Notation Scheme for Improvising Musicians}

\author{Isaac Otto}

\date{November 2025 v.1.3}
...
\begin{titlepage}
    ...
    {\fontsize{32}{36}\bfseries On the Use and Interpretation of Otto-Glyphs\par}
    \rule{\textwidth}{1pt}\par
    \vspace{.3in}
    {\LARGE\scshape a brief primer on a novel\\notation scheme for\\improvising musicians\par}
    \vspace{.75in}
    {\huge Isaac Otto\par}
    \vfill
    {\LARGE \texttt{v.1.4 | November 2025}\par}
\end{titlepage}
...
\vspace*{\fill}
\begin{center}
    \textcopyright~2023 Isaac Otto. All rights reserved.
\end{center}    
\vspace*{\fill}
\newpage
...
% Fair warning: this introduction is somewhat wordy and boring. For those who might like to skip straight to the meat of the matter---descriptions of the glyphs themselves begin in \textbf{Chapter \ref{ch:global}}. For the rest of you, please allow the following diversion into the impetus behind this project. 
    ...
    \section{Connotative/denotative notation schemes: how it feels vs. what it says}
    ...
    \section{What this notation might be}
    ...
    %        \end{itemize}
        ...
        \section{Conducted improvisation vs. Otto-Glyphs}
    ...
    \section{Priorities: the importance of disobedience}
...
\newpage
    ...
    \section[Axes]{Axes: the territory on which we organize gesture}
    ...
    \section[Duration]{Duration: proportional vs. measured}
    \label{sec:duration}
    ...
    This is all fine and good for unaccompanied performance, but the problem is complicated by the addition of multiple players who desire some form of synchrony between them. In the context of a duo, trio, etc., proportional durations tend to hold more strictly---though there is, of course, still a good deal of leeway inherent in the system. 
            \begin{center}
            \glyphborder[width=.65\textwidth]{images/08-dur1.png} \trans{P1 plays open; P2 plays a single pitch which is interrupted by trills}
    ...
    In the above example, given that there is no additional information present, the precise duration of the bracketed figure is negotiated in real time by Player One (empty bracket) and Player Two (trilling single pitch). Player Two in effect determines the midpoint of the gesture by deciding when to enter. Upon Player Two's entry, Player One then has a strong hint as to when she should conclude her improvisation. This style of notation, of course, works best in small ensembles and when the composer prioritizes performer input and coordination over maximum replicability from performance to performance.
            ...
            \begin{center}
            \glyphborder[width=.6\textwidth]{images/08-dur2.png}\trans{develop something like this arpeggiated gesture for thirty seconds}
            \end{center}
...
Lastly, duration may be measured according to traditional rhythmic values (\halfNote, \quarterNote, \eighthNote). Glyphs lend themselves to being embedded in traditional notation quite easily---as such, one might find improvisatory gestures occupying staves alongside traditional figures.
            ...
            \begin{center}
                \glyphborder[width=.65\textwidth]{images/09-measure.png}\trans{play the melodic figure as written, then improvise freely for one measure of~\lilyTimeSignature{4}{4}, first getting louder, then softer.}
            \end{center}
...
Here, context tells us that the empty set of brackets occupies one full measure of \lilyTimeSignature{4}{4}. Predictably, the composer sacrifices creative leeway here for metric precision. Further, labels may aid in specifying the precise duration of a figure in a rhythmic context, as in the figure below.
            ...
            \begin{center}
            \glyphborder[width=.65\textwidth]{images/09-partialmeasure.png}\trans{open improvisation for a fixed duration (a dotted half-note) in the context of a metric grid}
            \end{center}
...
\newpage
    ...
    \section[The box]{The box: our clef}

            \begin{center}
            \glyphborder[scale=0.12]{images/01-box.png}\trans{empty box; no indications}
            \glyphborder[scale=0.12]{images/01-boxwithchord.png}\trans{play what follows over [imagined] A$\flat$ major chord}
            \glyphborder[scale=0.12]{images/01-boxwithair.png}\trans{the amount of air in your tone will change over the course of this gesture}
            \end{center}
        ...
        In the case of the box-with-a-slash, the \textbf{northwest} corner tends to be reserved for parameters which constrain pitch content (e.g. lead sheet symbols like \textbf{E$\flat\Delta{\sharp \textbf{11}}$}, mode indications like \textbf{G Dorian}, or other, more specialized marks\footnote{In the past I have used \textbf{XXIV} to indicate the incorporation of the 24-tone equal-tempered scale---i.e. quarter-tones}. Specific indications here should be spelled out specifically in the performance notes from piece to piece. The \textbf{southeast} corner, on the other hand, is usually used for modifiers which will change in degree or intensity over the course of the gesture group (e.g. amount of air in the sound, amount of ``growl,'' degree of \textit{sul ponticello}, mute position, etc.). For more information see Section~\ref{sec:lollipops} on \textbf{Lollipops and parameter changes}.

\newpage

    \section[Bracket notation]{Bracket notation: changing a sign's fixity}

    \begin{center}
    \glyphborder[width=.25\textwidth]{images/01-blankbracket.png}\trans{{open improvisation}} 
    \glyphborder[width=.3\textwidth]{images/01-demobracket.png}\trans{{play something like this combination of attacks}} 
    \glyphborder[width=.4\textwidth]{images/01-demobracket2.png}\trans{{play something like this combination of attacks}}
    \end{center}

        Simple \textbf{\gls{brackets}} are one of our most valuable tools for sculpting an improvised performance. The difference between an un-bracketed and a bracketed gesture is subtle, but makes all the difference in the world. In essence: any time brackets appear, they should be read as: \textbf{play something \textit{in this manner}}. How precisely \textbf{\textit{in this manner}} is interpreted will of course differ greatly between performers. For instance: Where the following figure indicates \textit{three short attacks and a brief legato passage} across a particular duration, its bracketed counterpart...

            \begin{center}
            \glyphborder[width=.25\textwidth]{images/01-3dotscurve.png}
            \glyphborder[width=.25\textwidth]{images/01-3dotscurvebracket2.png} 
            \end{center}
        ...
        Occasionally a player might run across \textbf{empty brackets}. These serve to indicate that improvisation is essentially unrestricted (except with respect to total duration). Exceptions occur when the empty brackets span only part of the vertical axis... 
            ...
            \begin{center}
            \glyphborder[width=.6\textwidth]{images/05-territory.png}\trans{{open improvisation across different registers of the instrument, but all over an [imagined] E $\flat$ diminished chord}}
            \end{center}
        ...
        Often, bracketed sections will be extended across the time-axis using a thin, dark \gls{arrow}---especially when only minimal information need be provided in the brackets themselves. This arrow indicates that play continues for the duration. No particular ``development'' of performed material need occur over the duration, though neither is it expressly forbidden.
            ...
            \begin{center}
            \glyphborder[width=.5\textwidth]{images/01-extarrow.png}\trans{{repeat something like this \textbf{\textit{pp}} to \textbf{\textit{mp}} gesture until double bar line}}
            \end{center}
...
\section[Dots, lines, and curves]{Dots, lines, and curves: the basic building blocks of gesture}
        ...
        Straight horizontal lines indicate longer attacks. In the case of percussive or non-sustaining instruments, these might be interpreted as a single attack which decays for the duration or as a stream of attacks in that given pitch-space. 
            ...
            \begin{center}
            \glyphborder[width=.3\textwidth]{images/01-3dotscurvebracket2.png}\trans{(in the manner of) three short attacks followed by a brief legato passage} \hspace{25pt}
            \glyphborder[width=.4\textwidth]{images/01-demobracket3.png}\trans{(in the manner of) three short attacks, a long low note, two more short attacks, and a pause}
            \end{center}
        ...
        I will take care to describe curves in more detail as I take it that despite the intuitiveness of a simple melodic contour, they are apt to be misunderstood. A curve across a given territory has a start, middle, and end point...
            ...
            \begin{center}
            \glyphborder[width=.25\textwidth]{images/01-basiccurve.png}\trans{{begin high, descend rapidly, end in middle register}}
            \end{center}
            
        \noindent ...and might be simple or more complex.
        
            \begin{center}
            \glyphborder[width=.2\textwidth]{images/01-simplecurve.png}\trans{{begin quiet, ascend, then rapidly descend while getting louder}} \hspace{25pt} 
            \glyphborder[width=.3\textwidth]{images/01-complexcurve.png}\trans{{follow this approximate contour}}
            \end{center}
            ...
            \begin{center}
            \glyphborder[width=.9\textwidth]{images/01-curvebreakdown.png}
            \end{center}
...
\newpage
        ...
        Trills are considered a proper subset of \gls{curve}s---namely curves which demonstrate rapid regular or irregular oscillation with a comparatively short ``wavelength.'' As such, there is no categorical distinction between a ``\gls{trill}'' and a complex curve. Unless otherwise noted, ``trill'' figures are not limited to half- or whole-step oscillation. The figure below demonstrates \textit{a rapid, louder trill, a crescendo on a single tone, then a slower, smoother trill}.
            ...
            \begin{center}
            \glyphborder[width=.6\textwidth]{images/08-trill2.png}
            \end{center}        
        ...
        Alternately, more conventional trills may be notated using the standard \textbf{\textit{tr}} figure, which may or may not be be accompanied by an interval/direction.
            ...
            \begin{center}
            \glyphborder[width=.5\textwidth]{images/08-trill1.png}\trans{{play something like these rhythms; trill over the longest tone}}
            \end{center}
...
\newpage
        ...
        \section[Dynamic indications]{Dynamic indications: varying stroke thickness}
        ...
        \begin{center}
            ...
            \begin{minipage}{0.8\textwidth}{}
                \begin{center}
                    \includegraphics[width=.9\textwidth]{images/02-varyingstrokedot.png} \\
                    \includegraphics[width=.9\textwidth]{images/02-varyingstrokeline.png} \\
                    \includegraphics[width=.9\textwidth]{images/02-varyingstrokecurve.png} 
                \end{center}
            \end{minipage}
            }%
        \end{center}
        ...
        During instances where little to no dynamic information is given (extended sections of uniformly thin lines, for example), the player is encouraged to tweak local dynamics themselves to suit the playing environment. For instance, the figure below need not be performed \textbf{\textit{ppp}} unless directions make it clear.\footnote{This is primarily a caveat included to prevent the engraving of large scores from becoming excessively onerous. Uniformly thin lines are simply easier to render and therefore may stand in for a ``choose-your-own-dynamic'' indication in the absence of other instructions}
            ...
            \begin{center}
                \glyphborder[width=.8\textwidth, angle=1.75]{images/02-thinline.png}\trans{long and short attacks on one pitch; two longer legato lines followed by several more attacks on a higher pitch}
            \end{center}
...
\subsection{Attack envelopes}
    ...
    Variations in \gls{stroke} width are often used to indicate specific \textbf{attack envelopes}. These can of course be combined with \textbf{curves}. Below, in no particular order, are a sampling of various possible attack envelopes. The first eight are seen on a single pitch; the final two combine changing attack envelopes with curves/trills.
        ...
        \glyphbordercontent{
            ...
            \begin{tabular}{cc}
            \includegraphics[width=.25\textwidth]{images/10-env1.png} & \includegraphics[width=.25\textwidth]{images/10-env2.png} \\
            \includegraphics[width=.25\textwidth]{images/10-env3.png} & \includegraphics[width=.25\textwidth]{images/10-env4.png} \\
            \includegraphics[width=.25\textwidth]{images/10-env5.png} & \includegraphics[width=.25\textwidth]{images/10-env6.png} \\
            \includegraphics[width=.25\textwidth]{images/10-env10.png} & \includegraphics[width=.4\textwidth]{images/10-env7.png} \\
            \includegraphics[width=.4\textwidth]{images/10-env8.png} & \includegraphics[width=.4\textwidth]{images/10-env9.png} 
            \end{tabular}
        }
        \end{center}
...
\newpage
    ...
    \section[Timbral flux]{Timbral flux: visual and sonic texture}

        

            \begin{center}
            \glyphborder[width=.8\textwidth]{images/02-timbre1.png}\trans{{from left to right: change timbre on a single pitch at a fixed dynamic; change timbre on a single pitch while getting louder; change timbre in the middle of a short attack; change timbre twice over the course of this legato phrase}}
            \end{center}

            \begin{center}
            \glyphborder[width=.6\textwidth]{images/02-timbre2.png}\trans{{change timbre multiple times throughout this long-tone}}
            \end{center}
...
\newpage
    ...
    \section[Simultaneity lines]{Simultaneity lines: tying events together}
        ...
        In scored music which is often unmetered, \textbf{gestural simultaneity} becomes an important notational concern. When two events are meant to coincide, a dashed vertical \gls{line} connects those two events (be they the beginnings or endings or middles of gestures). These most often occur \textbf{between} two players, but will also occur in a single player's music to clarify an otherwise ambiguous passage. 
            ...
            \begin{center}
            \glyphborder[width=.7\textwidth]{images/02-sim2.png}
            \end{center}
        ...
        \noindent In the figure above, simultaneity lines are shown between the two players. The first player begin with a crescendo on a single tone with an abrupt cutoff; the second player begins \textbf{as soon as} the first player rests. After a short passage, both play a staccato attack together.
            ...
            \begin{center}
            \glyphborder[width=.4\textwidth]{images/02-sim.png}\trans{{play this contour then (without a pause) jump down to a steady low pitch}}
            \end{center}
    ...
    \subsection*{Cuing}
        ...
        Occasionally, for ease of rehearsal and performance,\textbf{ markers in the form of stars} will be placed above synchronous events to indicate potential \textbf{\gls{cue} points}---for instance, simultaneous attacks following fermata'd rests.
            ...
            \begin{center}
                \glyphborder[width=.7\textwidth]{images/08-star.png}\trans{Player 1 begins while Player 2 rests. Player 2 plays three short attacks at an unspecified position. Then, following a rest, both players re-enter simultaneously at the star.}
            \end{center}

    \newpage
        
    \section[Lollipops]{Lollipops: representing changing parameters}
    \label{sec:lollipops}
        ...
        ``\textbf{Lollipop}'' glyphs are used to indicate some \textbf{modifier}, i.e. a parameter which varies over the course of a gesture. As mentioned in Section 2.3 (\textbf{The box}), this parameter will usually be indicated in the southeast corner of the ``\gls{box}'' clef and may include things like bow position, airiness, noisiness, amount of mute, etc. Any parameter which could conceivably be represented with a single increasing and decreasing value could happily be encoded with \gls{lollipop}s:
            ...
            \begin{center}
            \glyphborder[width=.5\textwidth]{images/02-lolly1.png}\trans{{an undefined parameter increases while this simple pitch contour is performed}}
            \hspace{15pt}
            \glyphborder[width=.5\textwidth]{images/02-lolly2.png}\trans{{an undefined parameter oscillates on a single pitch in an in-this-manner bracket}}
            \end{center}

        \begin{center}
            \glyphborder[width=.8\textwidth]{images/02-lolly4.png} 
        \end{center}
        ...
        The first lollipop will appear where the changing parameter should begin and a dotted line will indicate the \textbf{relative degree} of that technique. I typically use strictly linear progressions from one lollipop to the next rather than curved lines---although there is no hard-and-fast rule saying this must be the case. A dashed line without an accompanying terminator indicates that the parameter should remain at its last value until ``reset'' at the next gesture. In the absence of any further information in subsequent gestures, one should assume that the lollipop no longer holds.
            ...
            \begin{center}
            \glyphborder[width=.8\textwidth]{images/02-lolly3.png}\trans{{a parameter decreases over the course of a legato phrase; the same parameter is specified again in the middle of a staccato passage and remains constant}}
            \end{center}
        ...
        As shown in the graphic below, two simultaneous changing parameters are relatively easy to deploy as long as both are clearly labelled. I suspect that attempting to represent more than two parameters would render a passage unwieldy and would perhaps best be saved for a different sort of compositional practice.
            ...
            \begin{center}
            \glyphborder[width=.9\textwidth]{images/02-lolly5.png}\trans{{a single pitch has two parameters modified: noisiness is represented by the top lollipop since it's given in the box; vibrato is represented by the bottom lollypop and is defined by the tag to the left}}
            \end{center}

    \newpage

    \section[Relational signs]{Relational signs: connecting players and gestures}

        A specific class of glyphs, \textbf{\gls{relational signs}} indicate some relationship between the currently active material and some other material---either another player's or one's own. In the following list, I have attempted to encompass quite a wide range of relational possibilities without developing so many new symbols that they begin to tax the performer's recall abilities. 


        Below are some commonly-used relational signs:
    ...
    \begin{tabular}{@{} p{0.18\textwidth} p{0.18\textwidth} p{0.54\textwidth} @{}}
        \toprule
        $\vcenter{\includegraphics[width=.1\textwidth]{images/03-match.png}}$ & \textit{match x} & match target's playing (in terms of pitch, rhythm, timbre, etc.) \\
        $\vcenter{\includegraphics[width=.1\textwidth]{images/03-ignore.png}}$ & \textit{ignore x} & perform as though target is not present \\
        $\vcenter{\includegraphics[width=.1\textwidth]{images/03-support.png}}$ & \textit{support x} & perform in such a way that target serves as the ``foreground'' to your ``background'' \\
        $\vcenter{\includegraphics[width=.1\textwidth]{images/03-dominate2.png}}$ & \textit{dominate x} & perform in such a way that target becomes ``background'' to your ``foreground'' \\
        $\vcenter{\includegraphics[width=.1\textwidth]{images/03-build.png}}$ & \textit{build upon x} & develop an idea presented by target (either another player or a previous gesture) \\
        $\vcenter{\includegraphics[width=.2\textwidth]{images/03-echo.png}}$ & \textit{echo x} & serve as an ``echo'' to target player or gesture \\
        $\vcenter{\includegraphics[width=.1\textwidth]{images/03-memorize.png}}$ & \textit{memorize x} & commit (some aspect(s) of) target to memory for later use \\
        $\vcenter{\includegraphics[width=.1\textwidth]{images/03-recall.png}}$ & \textit{recall x} & recall that which was committed to memory in the ``memorize'' gesture \\
        \bottomrule
    \end{tabular}
    \endgroup
    \end{center}
...
\renewcommand{\arraystretch}{2}
        \footnotesize
        \begin{tabular}{@{} p{0.25\textwidth} p{0.22\textwidth} p{0.48\textwidth} @{}}
            \toprule
            $\vcenter{\includegraphics[width=.25\textwidth]{images/03-louder.png}}$ & \textit{louder/softer} & \\
            $\vcenter{\includegraphics[width=.25\textwidth]{images/03-denser.png}}$ & \textit{denser/rarer} & \\
            $\vcenter{\includegraphics[width=.2\textwidth]{images/03-higher.png}}$ & \textit{higher/lower} & \\
            $\vcenter{\includegraphics[width=.2\textwidth]{images/03-purer.png}}$ & \textit{purer/noisier} & \\
            $\vcenter{\includegraphics[width=.2\textwidth]{images/03-faster.png}}$ & \textit{faster/slower} & \\
            $\vcenter{\includegraphics[width=.1\textwidth]{images/03-decompose.png}}$ & \textit{decompose x} & perform \textit{x} but with ``pieces missing'' or in some way incomplete or broken-down \\
            $\vcenter{\includegraphics[width=.2\textwidth]{images/03-exaggerate.png}}$ & \textit{exaggerate x} & perform \textit{x} but in some way exaggerated (wider contours, louder, etc.) \\
            $\vcenter{\includegraphics[width=.2\textwidth]{images/03-rhythmicize.png}}$ & \textit{rhythmicize x} & perform \textit{x} but now conforming to some sort of rhythmic grid \\
            $\vcenter{\includegraphics[width=.2\textwidth]{images/03-rubato.png}}$ & \textit{rubato x} & perform \textit{x} but now without regard to a rhythmic grid \\
            $\vcenter{\includegraphics[width=.15\textwidth]{images/03-multiply.png}}$ & \textit{multiply x} & take a fragmentary gesture \textit{x} and multiply it indefinitely \\
            $\vcenter{\includegraphics[width=.15\textwidth]{images/03-counterpoint.png}}$ & \textit{counterpoint x} & provide counterpoint (rhythmically, pitch-wise, timbrally) to \textit{x} \\
            \bottomrule
        \end{tabular}
    \end{minipage}
    \end{center}
...
\vspace{10pt}
    ...
    Relational glyphs are most often placed at the bottom-left of an accompanying gesture and will use an \gls{arrow} to indicate its point of reference, be it another player's gesture or one's own previous material. If a new relational glyph overrides the previous one, the new glyph should be preceded by a cancellation mark (a diagonal line through the glyph).
    ...
    In context, the relational sign will be placed at the bottom-left of an accompanying gesture and will use an \gls{arrow} to indicate its point of reference, be it another player's gesture or one's own.
            ...
            \begin{center}
            \glyphborder[width=.6\textwidth]{images/05-relation1.png}\trans{{build upon previous gesture}}
            \end{center}

            \begin{center}
            \glyphborder[width=.4\textwidth]{images/05-relation2.png}\trans{{ignore other player's gesture}}
            \end{center}

            \begin{center}
            \glyphborder[width=.4\textwidth]{images/05-relation3.png}\trans{{echo other player's gesture}}
            \end{center}
...
\newpage
    ...
    \section{Other global signs}
        ...
        \subsection[Incorporating pitched material]{Incorporating pitched material}

            A central goal of this system is a more-or-less seamless integration of traditionally notated materials with new open glyphs. \textbf{\Gls{Pitched material}} may be incorporated in several ways. Rarely, notation may be included which is fully rendered with meter, tempo, dynamics, etc. However, more commonly, several of these factors are omitted in favor of fixed pitches to be played in a given order but with no rhythmic/durational information. Other times, no order is specified.

            \begin{center}
            \glyphborder[width=.8\textwidth]{images/06-Artboard 3.png}\trans{{over a D major chord play a falling gesture followed by three staccato attacks, then play something like the given chords, then play this accelerando gesture on A3}}
           
            \glyphborder[width=.5\textwidth]{./images/non_specific_pitches.png}\trans{{play something using these pitches with no particular rhythm}}
            \end{center}
            
           In instances where rhythms are given, these rhythms are to be performed proportionally unless otherwise noted.

            \begin{center}
            \glyphborder[width=.8\textwidth]{images/06-Artboard 2.png}\trans{{play something like these pitches/rhythms proportionally (not necessarily in sync with anyone else)}}
            \end{center}
        ...
        \subsection{Relative rests}
            ...
            \begin{center}
            \glyphborder[width=.6\textwidth]{images/03-rest.png}\trans{{one interrupted pitch followed by a long rest}}
            \end{center}        
            
            
            \begin{center}
            \glyphborder[width=.9\textwidth]{images/03-rest2.png}\trans{{play this gesture with rests of various proportional lengths}}
            \end{center}        
...
\newpage
        ...
        \subsection{Repeats}
            ...
            \begin{center}
            \glyphborder[width=.5\textwidth]{images/03-repeat1.png}\trans{{repeat this long-short-long figure}}
            \end{center}

            
            \begin{center}
            \glyphborder[width=.5\textwidth]{images/03-repeat2.png}\trans{{(in the manner of) a repetition of this staccato-then-single-tone phrase}}
            \end{center}

\newpage
            
        \subsection[Transition arrow]{Transition arrows: gradual becoming}
            ...
            \begin{center}
            \glyphborder[width=.9\textwidth]{images/03-transition.png}\trans{{transition rather quickly from a mix of longer and shorter attacks to consistent short attacks in a narrow pitch band}}
            \end{center}  

            Play need not be continuous during this transition period; rather, the player should isolate the salient parameter or parameters of the initial and final gestures and focus on gradually transitioning between them.

\newpage
            
\subsection[The rhythmic grid]{The rhythmic grid}

These symbols are used to indicate that improvisation should occur either \textbf{metronomically} (``on a grid''---i.e. using an imagined isochronous pulse governing performed rhythms), \textbf{semi-metronomically} (semi-pulsed), or \textbf{unmetered}.
            
            
            \begin{center}
            \glyphborder[width=.1\textwidth]{images/08-met1.png}
            \hspace{0.5cm}
            \glyphborder[width=.12\textwidth]{images/08-met2.png}
            \hspace{0.5cm}
            \glyphborder[width=.12\textwidth]{images/08-met3.png}
            \end{center}  
...
As usual, an arrow will be used to indicate the point of reference for the \textbf{match x}, \textbf{ignore x}, etc. relational signs.

            \begin{center}
            \glyphborder[width=.12\textwidth]{images/08-met4.png}
            \end{center}  
...
\newpage
        ...
        \subsection{Interruptions}
            ...
            Two symbols are used to indicate \textbf{interruptions} of the ongoing flow of a gesture. This glyph...

            \begin{center}
            \glyphborder[width=.1\textwidth]{images/05-interruption3.png} 
            \end{center}
            
            ...indicates an \gls{interruption} ``\textbf{in time}'' which interjects sound of the player's choosing in such a way that the proportionality of the gesture group is unaltered---often a sudden burst unrelated to the rest of the music in question.
            
            On the other hand, this glyph...
            
            \begin{center}
            \glyphborder[width=.15\textwidth]{images/05-interruption4.png}
            \end{center}
            
            ...indicates an interruption ``\textbf{out of time}''---i.e. of open duration, breaking not only the sonic flow, but also the \textit{temporal} flow of the gesture. 
...
\newpage
    ...
    \section{Polyphonic instruments}
        ...
        Homophonic gestures (that is, gestures which are primarily composed of vertically-stacked harmonies rather than monophonic single-note lines) present a unique challenge to notation in this scheme, given the scheme's reliance on essentially one-dimensional simple linear figures. As such, generically homophonic material is shown using \textbf{striated dots and contours} which are \gls{texture}d with \textbf{parallel, left-to-right oriented bands}.
            ...
            \begin{center}
            \glyphborder[width=.85\textwidth]{images/04-chords.png}\trans{{from left to right: long, chordal attack, quite loud; legato figure composed of chords; three short chordal attacks; wider-range chordal legato figure}}
            \end{center}  
    ...
    As usual, the approximate range of the gesture is given by its position on the y-axis. Note that the striations themselves do not give any particular information as to the intervallic content or chord voicing---these properties, if constrained at all, will be given elsewhere; usually in the accompanying \gls{box} or attached to the gesture with a flag. To this end, a widely-spaced staffless half-note \gls{chord} indicates that the player should favor more open voicings. Converseley, a clustered half-note chord points to tighter, closed voicings.
            ...
            \begin{center}
            \glyphborder[width=.3\textwidth]{images/04-chords2.png}\trans{{descending chordal legato passage primarily using ``closed'' or ``cluster'' voicings}}
            \hspace {15pt}
            \glyphborder[width=.2\textwidth]{images/04-chords3.png}\trans{{loud-soft-loud gesture using ``open'' (widely spaced) voicings}}
            \end{center}  
...
\newpage
    ...
    \section{Strings}
        ...
        \subsection{Harmonics}
            ...
            \begin{center}
            \glyphborder[width=.6\textwidth]{images/04-harmonics.png}\trans{{plain, unbroken harmonics}} 
            \hspace {15pt}
            \glyphborder[width=.4\textwidth]{images/04-harmonics2.png}\trans{{a ``morse-code'' ---i.e. mixed long and short attacks---harmonic}}
            \end{center} 
...
\newpage
        ...
        \subsection{Double-stops et al.}
            ...
            \begin{center}
            \glyphborder[width=0.5\textwidth]{images/04-doublestops.png}\trans{{a double stop on a single pitch which is interrupted toward the end of the gesture}} 
            \hspace {15pt}
            \glyphborder[width=0.4\textwidth]{images/04-doublestops2.png}\trans{{a double stop which begins and returns to a single pitch}}
            \end{center}

            \begin{center}
            \glyphborder[width=0.4\textwidth]{images/04-doublestops3.png}\trans{{a double stop which peaks in intensity toward the middle of the gesture}}
            \hspace {15pt}
            \glyphborder[width=0.3\textwidth]{images/04-doublestops4.png}\trans{{a triple stop using a C-augmented pitch set which rapidly ascends and gets louder}}
            \end{center}
...
\newpage
    ...
    \section{Winds}
        ...
        \subsection{Multiphonics}
            ...
            \begin{center}
            \glyphborder[width=0.3\textwidth]{images/04-multiphonics2.png}
            \hspace {15pt}
            \glyphborder[width=0.3\textwidth]{images/04-multiphonics3.png}\trans{{two discrete multiphonics in approximately the same register and with the same dynamic}}
            \end{center}

            \noindent In some instances, unspecified but \textbf{discrete} multiphonics are desired. In this case, the initial glyph will be \gls{texture}d using ``timbral change'' glyph textures. These distinctions are local to the gesture, similar to changes in \textbf{timbre}---i.e. the multiphonic signified by the hatched symbol need not be consistent across the entire piece; only until the \textbf{box} clef indicates the start of a new gesture.

            
            \begin{center}
            \glyphborder[width=.5\textwidth]{images/04-multiphonics4.png}\trans{{three discrete multiphonics at different dynamics}}
            \end{center}
...
\newpage
    ...
    \section{Brass}
        ...
        \subsection{Mutes}
            ...
            \begin{center}
            \glyphborder[width=.75\textwidth]{images/mutelolly.png}\trans{{interrupted attack(s) on a single pitch while opening/closing the mute}}
            \end{center}
    ...
    \section{Percussion}
        ...
        \subsection{Drum kit}
          ...
          In the figure below: typical trap kit components loosely arranged according to spectral content. Top to bottom: crash/splash; ride; snare; tom; bass. These may be changed to suit intended trap kit setup.
            ...
            \begin{center}
            \glyphborder[width=.1\textwidth]{images/05-drums.png}
            \end{center}
...
\noindent Here shown in context:
    ...
    \subsection{Other percussion}
        ...
        Custom \gls{pictograms} may serve a valuable role in efficiently communicating a desired technique. Shown below are just a few that have been deployed in past pieces.
            ...
            \begin{center}
            \glyphborder[width=.8\textwidth]{images/percussionpictograms.png}\footnote{Left in box: various sticks/mallets\\Center: various cymbals/drums\\Right: bow}
            \end{center}

\newpage

\chapter{Further examples}
\label{ch:further-examples}
\newpage

\section{\textit{Q-tet} (2022/3) for jazz quartet}

\begin{center}

    \glyphborder[width=.85\textwidth]{images/ex01-qtet.png}\trans{the drummer plays circular gestures across the middle register of the kit, punctuating occasionally with quiet kicks; transitions to doubles across the kit which gradually accelerate; a flurry on kicks and low toms}

    \glyphborder[width=.65\textwidth]{images/ex02-qtet.png}\trans{the drummer plays rapid gestures on cymbals, hi-hat, and snare while modulating an undefined parameter (perhaps timbre or dynamic)}

    \glyphborder[width=.85\textwidth]{images/ex03-qtet.png}\trans{the bassist plays loud but rapidly decaying attacks in the low register with pairs of harmonics ringing out above; rapid tremolo gestures separated by rests, all slowing gradually}

\end{center}

\section{\textit{High Structure Carbon Black} (2023) for solo saxophone}

\begin{center}
    \glyphborder[width=.8\textwidth]{images/ex05-hscb.png}\trans{the saxophonist plays brief fixed melodic cell, an (in the manner of) aggressive legato gesture (recorded as gesture~\delta), another cell, then a series of separated and legato attacks arcing upward}

    \glyphborder[width=.8\textwidth]{images/ex04-hscb.png}\trans{the saxophonist plays a longer fixed phrase, then a passage on (something like) an E$\Delta$ chord; the player is asked to build upon the recorded gesture~\delta from earlier in the piece}
\end{center}


\section{\textit{W/M} (2023) for variable ensemble}

\begin{center}
    \includegraphics[width=.95\textwidth]{images/wm02.png}\trans{four semi-fixed gestures comprising short and long attacks at various pitch heights, as well as a few short legato attacks; the first three gestures feature interruptions, either in time or out-of-time}
\end{center}

\section{``Interlude I'' for clarinet and kamancheh}

\begin{center}
    \glyphborder[width=.95\textwidth]{images/ex06-interlude.png}
\end{center}

\section{\textit{Nemat-Space} (2023) for two multi-instrumentalists}
